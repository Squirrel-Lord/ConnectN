...
* Author: Ross Baldwin
*
* This program lets two users play ConnectN. ConnectN is similar
* to Connect4, only the size of the game board and the winning
* number of consecutive chips can be easily changed by a user.
*/
package connectn;
